#ifndef ANET_INCLUDE_ANET_UTIL_OBJECT_POOL_HPP_
#define ANET_INCLUDE_ANET_UTIL_OBJECT_POOL_HPP_
...
} // namespace anet::util::object_pool

} // namespace anet::util

#endif //ANET_INCLUDE_ANET_UTIL_OBJECT_POOL_HPP_
